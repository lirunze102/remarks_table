    ...
    <div class="main-container">
        ...
        <div class="content">
            <div class="row">
                <div class="col-sm-12">
                    <div class="white-box">
                        <h3 class="box-title">子模块信息表</h3><br>
                        <span style="margin-left: 900px"><a href="sectionParent.jsp">返回</a></span>
                        <br><br>
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                <%
                                    int sParentId= Integer.parseInt(request.getParameter("sParentId"));
                                    System.out.println("sParentId:"+sParentId);
                                    List<Section> sections = new ArrayList<>();
                                    SectionDao sectionDao=new SectionDaoImp();
                                    sections=sectionDao.selectSonSection(sParentId);
                                    int pageCount=5;
                                    ...
                                    for(int i=0;i<pageCount;i++){
                                        ...
                                        topicCount=topicDao.topicCount(sections.get(i).getsId());
                                %>
                                <tr>
                                    <td><%=i+1%></td>
                                    ...
                                    <td><%=topicCount%></td>
                                    <th><a href="adminTopic.jsp?id=<%=sections.get(i).getsId()%>">详情</a> &nbsp;&nbsp;&nbsp;
                                        <a href="deleteChildSection.jhtml?id=<%=sections.get(i).getsId()%>">删除</a>
                                    &nbsp;&nbsp;&nbsp;<a href="changeChildSection.jsp?id=<%=sections.get(i).getsId()%>">修改</a></th>
                                </tr>
                                <%
                                    }
                                %>
