        ...
        <div class="row">
            ...
            <div class="span8 page-content">
                <ul class="breadcrumb" style="margin-left: -60px">
                    <li><a href="#">个人信息</a><span class="divider">/</span>
                        </li>
                    <li><a href="#" title="View all posts in Server &amp; Database">个人信息详情</a> <span class="divider">/</span></li>
                </ul>
                ...
                <div class="form-group row">
                    <div class="col-sm-9">
                        ...
                        <input type="text" class="form-control" id="uName" placeholder="用户名" style="margin-top:
                        10px;margin-left: 35px" value="<%=uName%>"  disabled="disabled">
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-sm-9">
                        <span class="col-sm-3 text-right control-label col-form-label">密码:</span>
                        <input type="password" class="form-control" id="uPassWord" style="margin-top: 10px;margin-left: 48px" value="<%=password%>" disabled="disabled">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        ...
                        <input type="text" class="form-control" id="usex" style="margin-top: 10px;margin-left: 48px" value="<%=usex%>" disabled="disabled">
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-sm-9">
                ...
                <div class="form-group row">
                    <div class="col-sm-9">
                        ...
                        <%--<input type="text" class="form-control" id="uType" style="margin-top: 10px;margin-left: 20px">--%>
