...
@WebServlet(name = "AdminDeleteTopic")
public class AdminDeleteTopic extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(topicDao.deleteBytId(tId) &&sectionDao.deletecount(sId)){
            ...
            request.getRequestDispatcher("adminTopic.jsp?id="+sId+"").forward(request,response);
        }
    }
}
